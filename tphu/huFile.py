...
# Navigate backward one directory to access 'tp1'
SHAPES_FOLDER_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), 'shapes'))
...
def process_images_folder():
    ...
    # Iterate over subdirectories (classes) in 'shapes'
    for label, class_folder in enumerate(os.listdir(SHAPES_FOLDER_PATH), start=1):
        ...
        # Ensure class_folder_path is a directory
    ...
    # Specify the output folder (data) within the project folder (tp2)
    ...
    print("HuMoments have been saved to the extra_huMoments.csv in data folder.")
